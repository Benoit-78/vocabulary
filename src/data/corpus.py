"""
    Provide a relevant corpus of English words to the user.
    So that the user does not need to constitute the corpus of words himself.
"""

# Gather a large corpus of words OR many corpora of words
### Remove the potential stopwords
